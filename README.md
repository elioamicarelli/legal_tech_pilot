...
In 2016 I have been in contact with a dutch legal tech start-up named newCobra connected with the ARAG legal insurance group. The start-up had a general interest in exploring options to innovate the current procedures adopted by the ARAG group so they provided to me an heterogeneous sample of the data available in their database. 
